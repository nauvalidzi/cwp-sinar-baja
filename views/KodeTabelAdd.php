...
loadjs.ready("head", function () {
    ...
    fkode_tabeladd = currentForm = new ew.Form("fkode_tabeladd", "add");
    ...
    // Validate form
    fkode_tabeladd.validate = function () {
    ...
    // Form_CustomValidate
    fkode_tabeladd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fkode_tabeladd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fkode_tabeladd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fkode_tabeladd" id="fkode_tabeladd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
