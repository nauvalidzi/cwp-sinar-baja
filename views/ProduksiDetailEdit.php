...
// Page object
$ProduksiDetailEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fproduksi_detailedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fproduksi_detailedit = currentForm = new ew.Form("fproduksi_detailedit", "edit");
    ...
    fproduksi_detailedit.addFields([
    ...
    // Validate form
    fproduksi_detailedit.validate = function () {
    ...
    // Form_CustomValidate
    fproduksi_detailedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fproduksi_detailedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fproduksi_detailedit.lists.idproduk = <?= $Page->idproduk->toClientList($Page) ?>;
    loadjs.done("fproduksi_detailedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fproduksi_detailedit" id="fproduksi_detailedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php } ?>
    ...
    <input type="hidden" data-table="produksi_detail" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
<?php if (!$Page->IsModal) { ?>
