...
<?php if ($Page->id->Visible) { // id ?>
        <th data-name="id" class="<?= $Page->id->headerCellClass() ?>"><div id="elh_produksi_id" class="produksi_id"><?= $Page->renderSort($Page->id) ?></div></th>
<?php } ?>
<?php if ($Page->tanggal->Visible) { // tanggal ?>
        <th data-name="tanggal" class="<?= $Page->tanggal->headerCellClass() ?>"><div id="elh_produksi_tanggal" class="produksi_tanggal"><?= $Page->renderSort($Page->tanggal) ?></div></th>
<?php } ?>
<?php if ($Page->kode->Visible) { // kode ?>
        <th data-name="kode" class="<?= $Page->kode->headerCellClass() ?>"><div id="elh_produksi_kode" class="produksi_kode"><?= $Page->renderSort($Page->kode) ?></div></th>
<?php } ?>
<?php if ($Page->total->Visible) { // total ?>
        <th data-name="total" class="<?= $Page->total->headerCellClass() ?>"><div id="elh_produksi_total" class="produksi_total"><?= $Page->renderSort($Page->total) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_produksi_id">
...
<span id="el<?= $Page->RowCount ?>_produksi_tanggal">
...
<span id="el<?= $Page->RowCount ?>_produksi_kode">
...
<span id="el<?= $Page->RowCount ?>_produksi_total">
