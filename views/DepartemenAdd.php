...
loadjs.ready("head", function () {
    ...
    fdepartemenadd = currentForm = new ew.Form("fdepartemenadd", "add");
    ...
    // Validate form
    fdepartemenadd.validate = function () {
    ...
    // Form_CustomValidate
    fdepartemenadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fdepartemenadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fdepartemenadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fdepartemenadd" id="fdepartemenadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
