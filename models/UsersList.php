...
class UsersList extends Users
{
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->iddepartemen->AdvancedSearch->toJson(), ","); // Field iddepartemen
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function restoreFilterList()
    {
        ...
        // Field iddepartemen
        $this->iddepartemen->AdvancedSearch->SearchValue = @$filter["x_iddepartemen"];
        $this->iddepartemen->AdvancedSearch->SearchOperator = @$filter["z_iddepartemen"];
        $this->iddepartemen->AdvancedSearch->SearchCondition = @$filter["v_iddepartemen"];
        $this->iddepartemen->AdvancedSearch->SearchValue2 = @$filter["y_iddepartemen"];
        $this->iddepartemen->AdvancedSearch->SearchOperator2 = @$filter["w_iddepartemen"];
        $this->iddepartemen->AdvancedSearch->save();
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->iddepartemen); // iddepartemen
    ...
    protected function setupListOptions()
    {
        ...
        // "detail_departemen"
        $item = &$this->ListOptions->add("detail_departemen");
        $item->CssClass = "text-nowrap";
        $item->Visible = $Security->allowList(CurrentProjectID() . 'departemen') && !$this->ShowMultipleDetails;
        $item->OnLeft = false;
    ...
    public function renderListOptions()
    {
        ...
        // "detail_departemen"
        $opt = $this->ListOptions["detail_departemen"];
        if ($Security->allowList(CurrentProjectID() . 'departemen')) {
            $body = $Language->phrase("DetailLink") . $Language->TablePhrase("departemen", "TblCaption");
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("DepartemenList?" . Config("TABLE_SHOW_MASTER") . "=users&" . GetForeignKeyUrl("fk_iddepartemen", $this->iddepartemen->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
            ...
            if ($detailPage->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'users')) {
                ...
                $url = $this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=departemen");
                $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . HtmlImageAndText($caption) . "</a></li>";
                if ($detailViewTblVar != "") {
                    $detailViewTblVar .= ",";
                }
                $detailViewTblVar .= "departemen";
            }
            if ($detailPage->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'users')) {
                $caption = $Language->phrase("MasterDetailEditLink");
                $url = $this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=departemen");
                $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . HtmlImageAndText($caption) . "</a></li>";
                if ($detailEditTblVar != "") {
                    $detailEditTblVar .= ",";
                }
                $detailEditTblVar .= "departemen";
            }
            if ($links != "") {
    ...
    protected function setupOtherOptions()
    {
        ...
        $detailTableLink = "";
                $item = &$option->add("detailadd_departemen");
                $url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=departemen");
                $detailPage = Container("DepartemenGrid");
