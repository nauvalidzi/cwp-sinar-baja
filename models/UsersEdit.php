...
class UsersEdit extends Users
{
    ...
    protected function validateForm()
    {
        ...
        if (in_array("departemen", $detailTblVar) && $detailPage->DetailEdit) {
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // iddepartemen
            $this->iddepartemen->setDbValueDef($rsnew, $this->iddepartemen->CurrentValue, 0, $this->iddepartemen->ReadOnly);
