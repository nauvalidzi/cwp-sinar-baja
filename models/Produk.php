...
class Produk extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('produk', 'produk', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // kode
        $this->kode = new DbField('produk', 'produk', 'x_kode', 'kode', '`kode`', '`kode`', 200, 25, -1, false, '`kode`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nama
        $this->nama = new DbField('produk', 'produk', 'x_nama', 'nama', '`nama`', '`nama`', 200, 255, -1, false, '`nama`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // deskripsi
        $this->deskripsi = new DbField('produk', 'produk', 'x_deskripsi', 'deskripsi', '`deskripsi`', '`deskripsi`', 201, 65535, -1, false, '`deskripsi`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // harga
        $this->harga = new DbField('produk', 'produk', 'x_harga', 'harga', '`harga`', '`harga`', 5, 10, -1, false, '`harga`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "ProdukEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ProdukAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ProdukView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ProdukView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ProdukAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ProdukAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ProdukEdit", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ProdukEdit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ProdukAdd", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ProdukAdd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ProdukDelete", $this->getUrlParm());
    }
