 ...
 * Page class
 */
class PenjualanDelete extends Penjualan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PenjualanDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PenjualanList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PenjualanList"); // Return to list
                return;
            }
        }
