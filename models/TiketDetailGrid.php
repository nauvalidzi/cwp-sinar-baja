 ...
 * Page class
 */
class TiketDetailGrid extends TiketDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TiketDetailGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "ftiket_detailgrid";
    ...
    public function emptyRow()
    {
        ...
        if ($CurrentForm->hasValue("x_deskripsi") && $CurrentForm->hasValue("o_deskripsi") && $this->deskripsi->CurrentValue != $this->deskripsi->OldValue) {
            return false;
        }
        return true;
    }
    ...
    public function resetFormError()
    {
        ...
        $this->deskripsi->clearErrorMessage();
    }
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_deskripsi")) {
            $this->deskripsi->setOldValue($CurrentForm->getValue("o_deskripsi"));
        }
    }
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "tiket") {
            $this->idtiket->CurrentValue = $this->idtiket->getSessionValue();
        }
        $conn = $this->getConnection();
        ...
        if ($this->idtiket->getSessionValue() != "") {
            $rsnew['idtiket'] = $this->idtiket->getSessionValue();
        }
