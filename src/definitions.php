...
return [
    ...
    // Tables
    "departemen" => \DI\create(Departemen::class),
    "kode_tabel" => \DI\create(KodeTabel::class),
    "penjualan" => \DI\create(Penjualan::class),
    "penjualan_detail" => \DI\create(PenjualanDetail::class),
    "produk" => \DI\create(Produk::class),
    "produksi" => \DI\create(Produksi::class),
    "produksi_detail" => \DI\create(ProduksiDetail::class),
    "tiket" => \DI\create(Tiket::class),
    "tiket_detail" => \DI\create(TiketDetail::class),
    "tiket_subjek" => \DI\create(TiketSubjek::class),
